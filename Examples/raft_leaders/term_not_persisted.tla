...
Restart(i) ==
    ...
    \* should lead to an error, currentTerm should be persisted
    /\ currentTerm' = [currentTerm EXCEPT ![i] = 1]
    /\ UNCHANGED <<messages, votedFor>>
...
\* Last modified Wed Nov 08 02:31:44 NOVT 2023 by andrey
